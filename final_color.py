...
CATAGORIES = ["car","motorbike","person"]
...
cap = cv2.VideoCapture('video/police_chase2.mp4')
frameSkipped = 1
        ...
        if method is "optical":
            if flowType is "DLK1":
                ...
                for c in cnts:
                    ...
                    cv2.putText(box, objClass, (x + w,y + h), cv2.FONT_HERSHEY_SIMPLEX, 1, dominant_color, 2, cv2.LINE_AA) # display detected object class name
                    i=i+1
                    uid=uid+1
